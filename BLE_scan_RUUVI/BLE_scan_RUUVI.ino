...
String payload;
String MAC_add = "c6:6e:8c:8f:4d:6c"; //All the identified MAC addresses will go in one String

const char* ssid     = "Minion";              //Main Router      
const char* password = "TLJL2019";            //Main Router Password
